...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockProjects = [
      { id: '1', name: 'Personal Blog', lastUpdated: new Date(), previewUrl: '/placeholder.svg' },
      { id: '2', name: 'Portfolio Website', lastUpdated: new Date(Date.now() - 86400000), previewUrl: '/placeholder.svg' },
      { id: '3', name: 'Task Management App', lastUpdated: new Date(Date.now() - 172800000), previewUrl: '/placeholder.svg' },
    ];
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border p-6">
            <h2 className="text-xl font-semibold mb-2">
              {user ? `Welcome back, ${user.email?.split('@')[0] || 'User'}` : 'Welcome to Orion'}
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {user 
                ? "Here's an overview of your projects and activity."
                : "Sign in to save your projects and access more features."}
            </p>
            {!user && (
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border p-6">
            ...
            {projects.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <Link
                  to="/"
                  className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow group bg-gray-50 dark:bg-gray-800/50 flex items-center justify-center aspect-[4/3]"
                >
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border p-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                <Coffee className="h-8 w-8 text-cyan-500" />
                <div>
                  <h3 className="text-lg font-semibold text-cyan-600">Support Our Work</h3>
                  <p className="text-gray-600 dark:text-gray-400">
                    Help us keep Orion free and continuously improving!
                  </p>
                </div>
              </div>
              <a 
